...
moon.(This could probably be better orgainzed as a small subplot)",
                    ...
                    {
                        this.Characters.Mu_voice,
                        this.Characters.Mu_image,
                        this.Characters.Mu_collector
                    }.ToList(),
...
the room.  There is a break in the sounds.  Maybe a heartbeat of silence and then ""I answer all.""",
                    description = 
@"    Mu answers any questions it is asked. This will occure for exactly 1 hour. 
...
The last of the glowing mist streams away. The night seems colder.",
                    description = 
@"    This is the completion of the prologue. Will our heros hunt the controller of Mu?
        ...
        public plot Witness_Prologue
        {
            get
            {
                return new plot
                {
                    gm_name = "Prologue",
                    introduction = 
@"  As you at meet at =character= =residence= discussing the latest news, a raised
voice from the back interupts.
    ""This is absurd, I will not be judge by this... this... mob! Leave me alone.""",
                    description =
@"  To witness. To see, hear, smell, touch, know.  To introduce, set the scene, 
welcome the elements, begin. Characters and players will see each other. Native
and foreign will be defined. Justice, law, deception, conspiracy.
    Relationships will be given to players at the gm's discrection. Use priorties
as guidence. A crime/taboo has been broken and a character declares their innocense.
The party is involved during the confrontation at the =residence=. Action 
to investigate  leads to a =coincedence= involved in the crime. Inaction or
incompetence and a party member will be =framed=. Along the way there could be a 
good =opportunity=, a =familiar face= or the discharge of an =obligation=.
    Depending on the relationship chosen the participant could have more or less
direct control over the setting or characters. So the person who chooses =residence=
could get to decide what type of setting.  Is it a practice court? the local food
plaza? What do the people and their buildings look like. The =framed= relationship
could be directed towards the person who decides not to take a relationship. The
=coincedence= relationship allows a player to have insight into the truth of the
matter while failure could harm their long term interests. The remainder add some
spice.",
                    relationships = new relationship[]
                    {
                        new relationship
                        {
                            gm_name = "residence",
                            description = 
@"The character has an active, recent history with the location.",
                            priority = 0,
                            creation_history = new creation_process[] 
                            {
                                CreationProcesses.Plot.GameMasterCreated
                        ...
                        new relationship
                        {
                            gm_name = "framed",
                            description = 
@"The character has suspicions directed towards them.",
                            priority = 1,
                            creation_history = new creation_process[] 
                            {
                                CreationProcesses.Plot.GameMasterCreated
                        ...
                        new relationship
                        {
                            gm_name = "coincedence",
                            description = 
@"A character's long term interest is involved in the plot.",
                            priority = 2,
                            creation_history = new creation_process[] 
                            {
                                CreationProcesses.Plot.GameMasterCreated
                        ...
                        new relationship
                        {
                            gm_name = "familiar face",
                            description = 
@"The character sees someone they recognize from their past.",
                            priority = 3,
                            creation_history = new creation_process[] 
                            {
                                CreationProcesses.Plot.GameMasterCreated
                        ...
                        new relationship
                        {
                            gm_name = "opportunity",
                            description = 
@"  The character will be presented with an risk/reward opportunity weighted 
towards their strength.",
                        ...
                        new relationship
                        {
                            gm_name = "obligation",
                            description =
@"The character feels obligated to complete a task.",
                            priority = 3,
                            creation_history = new creation_process[] 
                            {
                                CreationProcesses.Plot.GameMasterCreated
